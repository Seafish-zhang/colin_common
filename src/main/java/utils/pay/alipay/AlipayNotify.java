...
import utils.pay.alipay.AliPayConfigUtil;
...
public class AlipayNotify {
    ...
    public static boolean verify(Map<String, String> params) throws AlipayApiException {
	    ...
	    boolean isSign = AlipaySignature.rsaCheckV1(params, AliPayConfigUtil.getProperty("batch_trans_ali_pubkey"),
...
//    }
    ...
    */
    private static String verifyResponse(String notify_id) {
        ...
        String partner = AliPayConfigUtil.getProperty("partner");
